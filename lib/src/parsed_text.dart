...
class ParsedText extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // Parse the whole text and adds "%%%%" before and after each matched text
    // this will be used to split the text effectively
    parse.forEach((e) {
    ...
    // checks if each word matches patterns
    // if match found, creates a TextSpan with its function or return a default Text
